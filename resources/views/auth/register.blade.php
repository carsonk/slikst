							...
							<div class="col-md-6">
								<div class="">
									<div class="input-group">
										<input type="text" class="form-control suggestion-input" data-submit-to="{{ url('/schools/search/') }}"  data-suggestion-submit-to="{{ url('/schools/search/') }}" data-return-field="schools" name="school" value="{{ old('school') }}" autocomplete="off" />
